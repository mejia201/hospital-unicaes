      ...
      cell: row => (
        <div className="btn-group mt-2 mb-2" role="group" aria-label="Paciente actions">
          ...
          <Button 
            ...
            onClick={() => togglePacienteState(row.id_paciente)}
          >
      ...
      <Modal show={showModal} onHide={handleCloseModal} size="xl">
                ...
                <Form>
                  ...
                  <Col md={4}>
                    <Form.Group>
                      ...
                      <Form.Control name="fecha_nacimiento_paciente" onChange={handleInputChange} type="date"
                            value={
                              userForm.fecha_nacimiento_paciente
                                ? userForm.fecha_nacimiento_paciente.split("T")[0] // Extraer solo la fecha
                                : ""
                            }
                          isInvalid={!!errors.fecha_nacimiento_paciente} required/>
                  ...
                  <Form.Group>
                      ...
                      <Form.Select name="sexo_paciente" onChange={handleInputChange} value={userForm.sexo_paciente || ""} isInvalid={!!errors.sexo_paciente} >
              ...
              <Modal.Footer>
                ...
                <Button
                  variant="primary"
                  onClick={
                    userForm.id_paciente ? handleEditUser : handleSaveUser
                  }
                >
                  {userForm.id_paciente
                    ? "Actualizar Paciente"
